...
class Chat {
    ...
    async fetchHistory(pageNumber) {
        ...
        const request = await this.requester.request(`https://plus.character.ai/chat/history/msgs/user/?history_external_id=${this.externalId}${pageString}`, {
    ...
    async sendAndAwaitResponse(optionsOrMessage, singleReply) {
        ...
        const request = await this.requester.request('https://plus.character.ai/chat/streaming/', {
    ...
    async generateImage(prompt) {
        ...
        const request = await this.requester.request('https://plus.character.ai/chat/generate-image/', {
            headers:client.getHeaders(),
            method:'POST',
            client:this.client,
    ...
    async getSavedConversations(amount = 50) {
        ...
        const client = this.client;
        const request = await this.requester.request(`https://plus.character.ai/chat/character/histories/`, {
            headers:client.getHeaders(),
            method:'POST',
    ...
    async deleteMessage(messageId) {
        ...
        const client = this.client;
        const request = await this.requester.request(`https://plus.character.ai/chat/history/msgs/delete/`, {
            headers:client.getHeaders(),
            method:'POST',
            body: Parser.stringify({
    ...
    async saveAndStartNewChat() {
        ...
        const client = this.client;
        const request = await this.requester.request(`https://plus.character.ai/chat/history/create/`, {
            headers:client.getHeaders(),
            method:'POST',
            body: Parser.stringify({
